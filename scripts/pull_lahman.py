from pybaseball.lahman import people, parks, all_star_full, appearances, awards_managers,\
                                ...
                                salaries, schools, series_post, teams, teams_franchises,\
                                teams_half
from utils import configure_logging, sleep_random, pull_single_table
